...
def value_of_ace(card_one, card_two):
    ...
    if card_one == 'A' or card_two == 'A':
        return 1
    elif abs(value_of_card(card_one) + value_of_card(card_two) - 21) >= 11:
        return 11
    else:
        return 1
...
def is_blackjack(card_one, card_two):
    ...
    if card_one == card_two:
        return False
    if (value_of_card(card_one) == 10 and value_of_card(card_two) == 1) or value_of_card(card_one) == 1 and value_of_card(card_two) == 10:
        return True
    return False
